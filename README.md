...
4. When using some payment methods (e.g., PayPal), you may be redirected to an external Stripe page.
...
- Only logged-in users can access the Orders page
- Unregistered users are redirected to signup/signin page
